...
public class SDS_XR_DO implements Dp {

	private final static String TYPE_NAME = "SDS_XR_DO";
	private final XR xr;
	private String exportName = null;

	public SDS_XR_DO(XR xr) {
		this.xr = xr;
	}
	...
	public String getExportField(AsciiExportField field) {
		...
		case PeriphAddrMain:
			...
			pAddr.setElement(PeriphAddrE.TypeName, TYPE_NAME)
					...
					.setElement(PeriphAddrE._address_reference, "\"M." + xr.getPlc().getDriverModbus() + ".15." + xr.getAddress() + "\"")
